...
public:
	...
	//CHANG JING
	inline Matrix3 &mulvector( const Vector3<T>& vec1, const Vector3<T>& vec2);
...
template <typename T> inline Matrix3<T>::Matrix3( T d ) { 
...
template <typename T> inline Matrix3<T> operator+(const Matrix3<T>& lhs, const Matrix3<T>& rhs) {
	return Matrix3<T>(	lhs.data[0]+rhs.data[0],
...
template <typename T> inline Vector3<T> operator*( const Matrix3<T>& mat, const Vector3<T>& vec) {
	return Vector3<T>  (mat.data[0]*vec[0] + mat.data[1]*vec[1] + mat.data[2]*vec[2],	
						mat.data[3]*vec[0] + mat.data[4]*vec[1] + mat.data[5]*vec[2],
						mat.data[6]*vec[0] + mat.data[7]*vec[1] + mat.data[8]*vec[2]);
}
//working~~~~~~~~~~~~~~~~~~~~
template <typename T> inline Matrix3<T> operator*( const Matrix3<T>& mat1, const Matrix3<T>& mat2) {
	return Matrix3<T>  (mat1.data[0]*mat2.data[0] + mat1.data[1]*mat2.data[3] + mat1.data[2]*mat2.data[6],	
						mat1.data[0]*mat2.data[1] + mat1.data[1]*mat2.data[4] + mat1.data[2]*mat2.data[7],
						mat1.data[0]*mat2.data[2] + mat1.data[1]*mat2.data[5] + mat1.data[2]*mat2.data[8],
						mat1.data[3]*mat2.data[0] + mat1.data[4]*mat2.data[3] + mat1.data[5]*mat2.data[6],
						mat1.data[3]*mat2.data[1] + mat1.data[4]*mat2.data[4] + mat1.data[5]*mat2.data[7],
						mat1.data[3]*mat2.data[2] + mat1.data[4]*mat2.data[5] + mat1.data[5]*mat2.data[8],
						mat1.data[6]*mat2.data[0] + mat1.data[7]*mat2.data[3] + mat1.data[8]*mat2.data[6],
						mat1.data[6]*mat2.data[1] + mat1.data[7]*mat2.data[4] + mat1.data[8]*mat2.data[7],
						mat1.data[6]*mat2.data[2] + mat1.data[7]*mat2.data[5] + mat1.data[8]*mat2.data[8]);
}


//working~~~~~~~~~~~~~~~~~~~~
template <typename T> inline Matrix3<T>  &Matrix3<T>:: mulvector( const Vector3<T>& vec1, const Vector3<T>& vec2) {

	data[0] = vec1.x*vec2.x; // column 1 
	data[3] = vec1.y*vec2.x; 
	data[6] = vec1.z*vec2.x;

	data[1] = vec1.x*vec2.y; // column 2 
	data[4] = vec1.y*vec2.y; 
	data[7] = vec1.z*vec2.y;

	data[2] =vec1.x*vec2.z; // column 3 
	data[5] =vec1.y*vec2.z; 
	data[8] =vec1.z*vec2.z;
