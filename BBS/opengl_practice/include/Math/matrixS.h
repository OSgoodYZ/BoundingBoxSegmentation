...
//	MatrixS.h - ver 0.1.0
//
//  Copyright (c) Inyong Jeon. 2005-2007. All rights reserved.
//
//  Primary Author: Inyong Jeon
...
// [0 4 5 0]
// [6 0 7 8] 
// int ri[5] = {0,1,3,5,8}; // 행의 인덱스. 각행
// int ci[8] = {0, 0,1, 1,2, 0,2,3}; //열의 인덱스
// T  val[8] = {1, 2,3, 4,5, 6,7,8}; // 그위치에 있는 값(value)
...
template <typename T> inline MatrixS<T>::MatrixS( int __n, int nnz ) {
	...
	ci = new int[numNonZeros];
	 //Matrix3d tempmat3(0,0,0,0,0,0,0,0,0);
