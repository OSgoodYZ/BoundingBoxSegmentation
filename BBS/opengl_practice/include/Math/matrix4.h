...
//	Distribution or modification without any permission is not allowed.
//
//==============================================================================	
...
template <typename T> inline Matrix4<T> Matrix4<T>::operator*( const Matrix4<T> &rhs ) const {
	return Matrix4<T>(	data[0]*rhs.data[0]+data[4]*rhs.data[1]+data[8]*rhs.data[2]+data[12]*rhs.data[3],
...
template <typename T> inline Vector3<T> Matrix4<T>::operator*( const Vector3<T> &rhs ) const {
	return Vector3<T>( data[0]*rhs[0] + data[4]*rhs[1] + data[8]*rhs[2] + data[12],
...
template <typename T> inline Vector4<T> Matrix4<T>::operator*( const Vector4<T> &rhs ) const {
	return Vector4<T>( data[0]*rhs[0] + data[4]*rhs[1] + data[8]*rhs[2] + data[12]*rhs[3],
...
template <typename T> inline Matrix4<T> Matrix4<T>::operator*( T d ) const {
	return Matrix4<T> ( data[0] *d, data[1] *d ,data[2] *d ,data[3] *d,
